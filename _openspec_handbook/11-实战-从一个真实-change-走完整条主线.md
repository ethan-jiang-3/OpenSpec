...
如果你读完这篇之后，感觉整条主线终于立住了，那么接下来有两个方向：

### 方向 A：马上补 artifacts 修改能力

真实使用时，跑完一次主线后最常遇到的问题是：AI 生成得不准，或者实现过程中发现规划要改。下一篇专门讲这个：

接着读 [`12` artifact 修改篇](12-实战-如何正确修改-artifacts.md)。

### 方向 B：回去补厚理解

回看这些篇章会顺很多：

[`02`](02-中级-把核心概念真正串起来.md) 和 [`03`](03-高级-openspec-的软件开发生命周期思想.md) 会更容易读懂。
...
再看 [`90` 附录](90-附录-给机器看的-agent-协议.md)。
