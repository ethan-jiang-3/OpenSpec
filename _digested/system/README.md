...
| 目录 | 视角 | 这里怎么衔接 |
|------|------|--------------|
| `system/` | 总体系统模型 | 解释 repo-local planning、store coordination、tool delivery、agent runtime API 如何组成整体 |
...
| 2 | `02-目录与状态边界.md` | repo-local、store、global data/config、agent 集成目录分别保存什么 |
| 3 | `03-planning-home-与-store-模型.md` | `PlanningHome` 简化与 v1.5.0 store 模型 |
...
- **想理解 store 模型**：`01` → `03`，再去看 `../mechanisms/01-store-模型与仓库协同.md`
