...
- [`../../_digested/specs_truth/01-机理-主specs如何被delta构造.md`](../../_digested/specs_truth/01-机理-主specs如何被delta构造.md) —— 主 specs 是 delta 经 `archive` 累加出来的，requirement 没 ID、身份是标题文本；**capability 身份是 `specs/` 下的相对 path**（可嵌套）。这是“为什么会失真”的根。
...
- [`../../_openspec_handbook/09-高级-能力身份与specs漂移维护.md`](../../_openspec_handbook/09-高级-能力身份与specs漂移维护.md) —— handbook 里讲清“capability 相对 path=身份、specs 为什么会漂、怎么守”的一章（用户向，比 specs_truth 通俗）。
