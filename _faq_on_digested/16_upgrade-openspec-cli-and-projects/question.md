...
1. **全局 CLI 本身**（PATH 上的 `openspec` 可执行文件）——它决定你能用哪些命令和参数（例如 v1.9.0 的 `--tools command-code`、`validate --archived`，以及 v1.8.0 的 `--tools agents`、`--copilot-cloud`、`retire_capabilities`，旧 CLI 根本没有）。
